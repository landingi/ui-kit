...
<Playground>
  <ColorNumber variant='success' size={16}>
    {' '}
    5{' '}
  </ColorNumber>
  <ColorNumber variant='success' size={18}>
    {' '}
    5{' '}
  </ColorNumber>
  <ColorNumber variant='success' size={32}>
    {' '}
    5{' '}
  </ColorNumber>
  <ColorNumber variant='success' size={44}>
    {' '}
    5{' '}
  </ColorNumber>
  <ColorNumber variant='success' size={62}>
    {' '}
    5{' '}
  </ColorNumber>
</Playground>
