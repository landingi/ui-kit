...
* @return {bool}
*/
export const isMediaQuery = breakpoint => window.matchMedia(`(max-width: ${breakpoint}px)`).matches
...
* @return {bool}
*/
export const isScreenSizeBetweenBreakpoints = (leftBreakpoint, rightBreakpoint) => {
